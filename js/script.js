...
${descripcion || "Sin descripción adicional."}`;
      ...
      window.open(
        "https://wa.me/541124830787?text=" + encodeURIComponent(mensaje),
        "_blank"
      );
    ...
    document
      ...
      .forEach((comparison) => {
        ...
        /*
          Desktop: mouse sobre toda la imagen.
        */
        ...
        /*
          Mobile: el usuario toca y mantiene el
          control central. Un gesto vertical no
          captura el movimiento y la página continúa
          desplazándose normalmente.
        */
    ...
    if (gallery && scrollbar && thumb) {
      ...
      function syncScrollbar() {
        ...
        const thumbWidth = Math.max(
          25,
          scrollbar.clientWidth * visibleRatio
        );
      ...
      function stopBarDrag(event) {
        ...
        if (event.pointerId !== barPointerId) {
          return;
        }
      ...
      /*
        Desktop + mobile:
        el carrusel distingue gesto vertical
        de gesto horizontal.
      */
      ...
      gallery.addEventListener(
        ...
        (event) => {
          ...
          if (
            event.target.closest(".comparison-control") ||
            event.target.closest(".gallery-scrollbar")
          ) {
            return;
          }
      ...
      function stopGalleryDrag(event) {
        ...
        if (event.pointerId !== galleryPointerId) {
          return;
        }
